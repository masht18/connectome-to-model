...
parser.add_argument('--model_save', type = str, default = 'saved_models/occluded_mult.pt')
parser.add_argument('--results_save', type = str, default = 'results/simple_occluded.npy')
